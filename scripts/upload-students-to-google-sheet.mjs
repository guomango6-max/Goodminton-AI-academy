...
const manifest = JSON.parse(await readFile(join(process.cwd(), 'data', 'student-manifest.json'), 'utf8'));
const students = manifest.filter((student) => student.studentId !== 'demo');
