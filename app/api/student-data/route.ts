...
const STUDENT_LOGIN_ALIASES: Record<string, { studentId: string; accessCode: string }> = {
  ...
  gyw: { studentId: 'guo-yiwei', accessCode: '1' },
  'guo-yiwei': { studentId: 'guo-yiwei', accessCode: '1' },
  guoyiwei: { studentId: 'guo-yiwei', accessCode: '1' },
  郭一苇: { studentId: 'guo-yiwei', accessCode: '1' },
  lcr: { studentId: 'li-chenrun', accessCode: '2' },
  'li-chenrun': { studentId: 'li-chenrun', accessCode: '2' },
  lichenrun: { studentId: 'li-chenrun', accessCode: '2' },
  李晨润: { studentId: 'li-chenrun', accessCode: '2' },
  sxy: { studentId: 'sheng-xinyi', accessCode: '3' },
  'sheng-xinyi': { studentId: 'sheng-xinyi', accessCode: '3' },
  shengxinyi: { studentId: 'sheng-xinyi', accessCode: '3' },
  盛欣怡: { studentId: 'sheng-xinyi', accessCode: '3' },
  xmj: { studentId: 'xue-meijiao', accessCode: '4' },
  'xue-meijiao': { studentId: 'xue-meijiao', accessCode: '4' },
  xuemeijiao: { studentId: 'xue-meijiao', accessCode: '4' },
  薛美姣: { studentId: 'xue-meijiao', accessCode: '4' },
  yjn: { studentId: 'yang-jingnan', accessCode: '8' },
  'yang-jingnan': { studentId: 'yang-jingnan', accessCode: '8' },
  yangjingnan: { studentId: 'yang-jingnan', accessCode: '8' },
  杨静南: { studentId: 'yang-jingnan', accessCode: '8' },
};
